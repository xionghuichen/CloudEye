...
# ret = api.faceset.create(outer_id='test9')
...
# api.faceset.addface(outer_id='test9', face_tokens=Face.itervalues())
# time.sleep(5)
# 对待比对的图片进行检测，再搜索相似脸
...
while(again):
    ...
    try:
        ...
        search_result = api.search(image_url=face_one, faceset_token='468d4f8ba70bddbf41aa9b3d2deeb04a')
